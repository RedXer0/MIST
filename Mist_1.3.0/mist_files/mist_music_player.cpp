...
void Mists_Playlist(){
    ...
    std::string Mists_Music_Playlist = "/home/xero/Mist_1.3.0/Mists_Music/music_playlist.txt";
    std::string Playlist_Pics = "/home/xero/Mist_1.3.0/mist_media/mists_music_pics.txt";
    std::cout << colors << ansi_colors << "m" << "Music_Player" << std::endl;
    sleep(2);
    std::cout << colors << ansi_colors << "m" << "All music is Non Copyrighted" << std::endl;
    sleep(2);
